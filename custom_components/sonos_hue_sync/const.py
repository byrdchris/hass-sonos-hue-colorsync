...
ARTWORK_STYLE_LABELS = {
    ...
    ARTWORK_STYLE_GRAPHIC: "High Contrast",
    ARTWORK_STYLE_PHOTOGRAPHY: "Photography",
    ARTWORK_STYLE_CINEMATIC: "Cinematic",
    ARTWORK_STYLE_SOFT: "Ambient",
    ARTWORK_STYLE_BOLD: "Vivid",
    ARTWORK_STYLE_MONOCHROME: "Monochrome / Neutral",
...
AUTO_STYLE_EXPRESSIVE = "expressive"
DEFAULT_AUTO_STYLE_BEHAVIOR = AUTO_STYLE_ACCURACY
...
NEUTRAL_TONE_LABELS = {
    ...
    NEUTRAL_TONE_WARM_AMBIENT: "Warm Neutral",
