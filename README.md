...
- Fixes an error when turning off Sonos Hue Sync.
- Renames the main switch to **Enable Sync**.
- Renames **Reapply Colors** to **Rotate Colors** to better describe its behavior.
- Reorders control entities so sync, palette behavior, brightness, actions, and diagnostics are easier to scan.
