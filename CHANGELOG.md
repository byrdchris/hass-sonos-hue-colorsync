...
- UI consolidation of artwork styles (Auto, Album Accurate, Ambient, Vivid, High Contrast, Monochrome)
- Improved Auto behavior consistency across playlists
- Refined Neutral Tone Handling to preserve chromatic accents
- Stabilized Palette Coherence modes (accent preservation improved)
- Fixed gradient ordering drift (Dark→Light and Light→Dark stability)
- Improved Auto Style Behavior consistency across album transitions
- HACS metadata version synchronization updated
